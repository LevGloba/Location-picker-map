...
import com.capstime.timecapsule.domain.Store
import com.capstime.timecapsule.domain.model.EnumAndroidWords
import com.capstime.timecapsule.domain.model.EnumSharedPreference
...
class LocationPickerActivity : AppCompatActivity(), OnMapReadyCallback, CheckVersionOSWhenCreateFragment {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        locationPickerViewModel.setTrack(LoggerEvent.LOCATION_PICKER_SCREEN_IS_OPEN)
        ...
        locationPermissionRequest = registerForActivityResult(
            ...
            when {
                ...
                permissions.getOrDefault(Manifest.permission.ACCESS_COARSE_LOCATION, false) -> {
                    ...
                    locationPickerViewModel.setTrack(LoggerEvent.LOCATION_PICKER_PERMISSION_TO_POSITION_FAIL)
                    Timber.tag("mapActivity").i("locationPermissionRequest: false")

                    val count = store.getTheNumberOfDeviations(EnumSharedPreference.NUMBER_OF_DEVIALIONS_LOCATION)
                    if (count >= 2)
                        alertDialogManager.createShowPermissionMap(this)
                    else
                        store.setTheNumberOfDeviations(EnumSharedPreference.NUMBER_OF_DEVIALIONS_LOCATION, count + 1)
    ...
    private fun initTouch() {
        ...
        mMap.setOnMapClickListener {
            locationPickerViewModel.setTrack(LoggerEvent.LOCATION_PICKER_TAP_ON_MAP)
            locationPickerViewModel.run {
                clearReyclerView()
                loadCardInfo()
                geocoderString.getAddress(
        ...
        binding.run {
            ...
            btUseThisLocation.setOnClickListener {
                locationPickerViewModel.setTrack(LoggerEvent.LOCATION_PICKER_BUTTON_USE_THIS_LOCATION_CLICK)
            ...
            mapActivitySearchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
                ...
                override fun onQueryTextSubmit(query: String?): Boolean {
                    ...
                    if (location.isNotBlank()) {
                        locationPickerViewModel.setTrack(LoggerEvent.LOCATION_PICKER_SEARCHING)
            ...
            mapActivitySearchView.findViewById<ImageView>(R.id.search_mag_icon).setOnClickListener {
                locationPickerViewModel.setTrack(LoggerEvent.LOCATION_PICKER_BUTTON_SEARCH_CLICK_ON)
            ...
            btMyLocation.setOnClickListener {
                locationPickerViewModel.setTrack(LoggerEvent.LOCATION_PICKER_GEO_POSITION_CLICK)
    ...
    private fun settingUserLocation() {
        if ((ActivityCompat.checkSelfPermission(
            ...
            locationPickerViewModel.setTrack(LoggerEvent.LOCATION_PICKER_PERMISSION_TO_POSITION_SUCCESS)
            mMap.isMyLocationEnabled = true
            mMap.uiSettings.isMyLocationButtonEnabled = false
            mMap.uiSettings.isCompassEnabled = false
            myLocation()
        } else {
            locationPickerViewModel.setTrack(LoggerEvent.LOCATION_PICKER_SHOW_PERMISSION_TO_POSITION)
            ...
            repeatOnLifecycle(Lifecycle.State.STARTED){
                locationPickerViewModel.uiState.collect { locationPickerUiStat ->
                    ...
                    binding.run {
                        ...
                        btUseThisLocation.isVisible = true//locationPickerUiStat.btCardView
                        btCloseCardInformation.isVisible = locationPickerUiStat.btCardView
                        textViewAdress.text = locationPickerUiStat.textViewAddress
                        textViewAdressCountry.text = locationPickerUiStat.textViewAddressCountry
            ...
            fusedLocationClient?.lastLocation?.addOnSuccessListener {
                locationPickerViewModel.run {
                    ...
                    try {
                        ...
                        showError("Failed to get last location")
                    }
                }
            }
        else
